...
<form  onsubmit="return validacion()"  name="Form1" id="Form1" method="post" action="alta.php" >
...
while ($row=mssql_fetch_array($resultados))
      ...
      <td align="left" valign="middle" class="contenido"><input id="personas" type="checkbox" value="1"  name="1" />
        <span class="Campos-Formulario">Personas</span></td>
        
        
      <td align="left" valign="middle" class="contenido" ><input id="delitos" type="checkbox" value="2"  name="2" />
        <span class="Campos-Formulario">Delitos</span></td>
      <td align="left" valign="middle" class="contenido" ><input id="vehiculos" type="checkbox" value="3"  name="3" />
        <span class="Campos-Formulario">Vehiculos</span></td>
      <td width="102" align="left" valign="middle" class="contenido" ><input name="4" type="checkbox" class="Campos-Contenido" id="objetos" value="4"  />
        <span class="Campos-Formulario">Objetos</span></td>
      <td width="99" align="left" valign="middle" class="contenido" ><input name="5" type="checkbox" class="Campos-Contenido" id="archivos" value="5"  />
        <span class="Campos-Formulario">Archivos</span></td>
      <td width="109" align="left" valign="middle" class="contenido" >
      <input name="6" type="checkbox" class="Campos-Contenido" id="burocratas" value="6"  />
        <span class="Campos-Formulario">Burocratas</span></td>
      <td width="102" align="left" valign="middle" class="contenido" >
      <input name="7" type="checkbox" class="Campos-Contenido" id="oficio" value="7" />
        <span class="Campos-Formulario">Oficio</span></td>

          </tr>
          
          <tr>
      <td align="left" valign="middle" class="contenido"><input id="compareciente" type="checkbox" value="8"  name="8" />
        <span class="Campos-Formulario">Comp</span></td>
      <td align="left" valign="middle" class="contenido" ><input id="fecha_cita" type="checkbox" value="9"  name="9" />
        <span class="Campos-Formulario">Fecha Cita</span></td>
      <td align="left" valign="middle" class="contenido" ><input id="fecha_documento" type="checkbox" value="10"  name="10" />
        <span class="Campos-Formulario">Fecha Doc</span></td>
      <td align="left" valign="middle" class="contenido" ><input name="11" type="checkbox" class="Campos-Contenido" id="vigente" value="11"  />
        <span class="Campos-Formulario">Vigente</span></td>
      <td align="left" valign="middle" class="contenido" ><input name="12" type="checkbox" class="Campos-Contenido" id="peritos" value="12"  />
        <span class="Campos-Formulario">Peritos</span></td>
      <td align="left" valign="middle" class="contenido" ><input name="13" type="checkbox" class="Campos-Contenido" id="psicologos" value="13"  />
      ...
      <td align="left" valign="middle" class="contenido" >
            ...
            <input name="14" type="checkbox" class="Campos-Contenido" id="mpiodocumento" value="14" <?PHP if($row['ver_mpiodocumento']==1) echo "checked='true'";?>  />
      ...
      <tr>
      <td align="left" valign="middle" class="contenido"><input id="tipodestinatario" type="checkbox" value="15"  name="15" />
        <span class="Campos-Formulario">Tipo Dest.</span></td>
      <td align="left" valign="middle" class="contenido" ><input id="personalquefirma" type="checkbox" value="16"  name="16" />
      ...
      <tr>
        ...
        <td width="130" class="Campos-Formulario">MENSAJE DE AYUDA:</td>
          ...
          <label for="mensaje_ayuda"></label>
              <textarea name="mensaje_ayuda" cols="80" rows="3" id="mensaje_ayuda" class="Campos-Contenido"></textarea>
          </td>
      </tr>         
        ...
        <table width="822" border="0">
          ...
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos1"></label>
              ...
              <input name="tipo_hechos" type="text" class="Campos-Contenido" id="tipo_hechos1" size="80" onChange="Mayusculas(this);" disabled="true" value="">                  </td>
          </tr>
          
  
          
          <!--activar o desactivar texto de tipo de echos-->
          ...
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos22"></label>
              ...
              <input name="tipo_hechos2" type="text" class="Campos-Contenido" id="tipo_hechos2" size="80" onChange="Mayusculas(this);" disabled="true">
			</td>
          </tr>
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos32"></label>
              ...
              <input name="tipo_hechos3" type="text" class="Campos-Contenido" id="tipo_hechos3" size="80" onChange="Mayusculas(this);" disabled="true">
			</td>
          </tr>
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos42"></label>
              ...
              <input name="tipo_hechos4" type="text" class="Campos-Contenido" id="tipo_hechos4" size="80" onChange="Mayusculas(this);" disabled="true">
			</td>
          </tr>
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos52"></label>
              ...
              <input name="tipo_hechos5" type="text" class="Campos-Contenido" id="tipo_hechos5" size="80" onChange="Mayusculas(this);" disabled="true">
			</td>
          </tr>
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos62"></label>
              <label for="tipo_archivo3">Titulo 6</label>
              <input name="tipo_hechos6" type="text" class="Campos-Contenido" id="tipo_hechos6" size="80" onChange="Mayusculas(this);" disabled="true">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="Campos-Formulario" colspan="7"><label for="tipo_hechos72"></label>
              ...
              <input name="tipo_hechos7" type="text" class="Campos-Contenido" id="tipo_hechos7" size="80" onChange="Mayusculas(this);" disabled="true">
            </td>
          </tr>
